...
public class GraphFragment extends Fragment {
    ...
    private void makeView(){
        ((TextView)wholeView.findViewById(R.id.textFragmentGraphHeight)).setText(mHeight*100+"cm");
        ((TextView)wholeView.findViewById(R.id.textFragmentGraphWeight)).setText(mWeight+"kg");
        ((TextView)wholeView.findViewById(R.id.textFragmentGraphBMI)).setText(String.format("%.2f", mBMI));
        ((TextView)wholeView.findViewById(R.id.textFragmentGraphBasis)).setText(calculateValue(mBMI, mMonth));
